...
$i18nLocale['webinstaller.step2.search-help'] = "Conservez la valeur par défaut en cas de doutes.";
$i18nLocale['webinstaller.step2.sampleAlt'] = "Exemples";
$i18nLocale['webinstaller.step2.sample'] = "Données d'exemple :";
$i18nLocale['webinstaller.step2.sample-help'] = "Cochez cette case pour créer un site d'exemple.";
...
$i18nLocale['webinstaller.configmanager.emptyTmpPathError'] = "Veuillez renseignez le dossier temporaire.";
