	...
	<div class="stepcontent">
		<?php if ($configManager->hasError()) { ?>
			<div class="error">
				...
				<?php if ($configManager->getError('others')) {
					echo "<br/>";
			...
			<div class="sectionfield">
				<ol>
					...
					<select name="install[SERVER_MAIL]" id="install_SERVER_MAIL">
						<option value="NOMAIL" <?php if ($configManager->getParameter('SERVER_MAIL') == 'NOMAIL') echo 'selected="selected"'; ?>>Aucun envoi</option>
						<option value="SENDMAIL" <?php if ($configManager->getParameter('SERVER_MAIL') == 'SENDMAIL') echo 'selected="selected"'; ?>>Sendmail</option>
						<option value="SMTP" <?php if ($configManager->getParameter('SERVER_MAIL') == 'SMTP') echo 'selected="selected"'; ?>>Smtp</option>
					</select>
					</li>
