...
<form class="cmxform" action="" method="post">
	...
	<div class="stepcontent">
		<div class="section">
			<img src="./ressources/section_domain.png" alt="Nom de doamine" />
		...
		<div class="section">
			...
			<div class="sectionfield">
				<ol>
					<li><label for="install_SOLR_URL">Données d'exemples: </label>
						<input name="install[SAMPLES]" class="textfield" value="checked"
	...
	<p class="download">
		...
		<?php if ($config->getParameter('checked')) { ?>
			<a href="javascript:submitStep02(); void 0;" title="Installer votre projet">Installation du projet</a>
		<?php }?>
	</p>
</form>
<script type="text/javascript">
window.onload = function() {initselectServermail();}
</script>
