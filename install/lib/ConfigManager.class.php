...
class ConfigManager
{
	 ...
	 * @var string
	 */
	public $productVersion = "3.6.4";
	
	/**
	 * @var string
	 */
	public $frameworkRepo = "3.6.4";
	...
	private function checkFQDN()
	{
		...
		$cr = curl_init();
		$options = array(CURLOPT_RETURNTRANSFER => true, CURLOPT_TIMEOUT => 5, CURLOPT_CONNECTTIMEOUT => 5, CURLOPT_FOLLOWLOCATION => false, 
			CURLOPT_URL => $url, CURLOPT_POSTFIELDS => null, CURLOPT_POST => false, CURLOPT_SSL_VERIFYPEER => false);
