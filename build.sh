...
rm -rf build/cmscore
mkdir build/cmscore
zip -r build/cmscore/cmscore-3.6.3.zip change.properties change.xml profile config install themes index.php repository

cp pack/ecommercecore.change.xml change.xml
rm -rf build/ecommercecore
mkdir build/ecommercecore
zip -r build/ecommercecore/ecommercecore-3.6.3.zip change.properties change.xml profile config install themes index.php repository

cp pack/cmsecomos.change.xml change.xml
rm -rf build/cmsecomos
mkdir build/cmsecomos
zip -r build/cmsecomos/cmsecomos-3.6.3.zip change.properties change.xml profile config install themes index.php repository
